...
data class Scenario(
    ...
    fun question() = "Did $criminal $action $kind Bonny Taylor with $weapon out of $motive?"
    fun statement() = "$criminal did $action $kind Bonny Taylor with $weapon out of $motive."
}
